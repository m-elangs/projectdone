...
<section class="checkout-orders">
   ...
   <h3>Your Orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>mothed payment:</span>
            <select name="method" class="box" required>
               <option value="cash on delivery">Cash On Delivery</option>
               <option value="credit card">Credit Card</option>
               <option value="paytm">Bank</option>
               <option value="paypal">Ewallet</option>
            </select>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>City :</span>
            <input type="text" name="city" placeholder="kota" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Province:</span>
            <input type="text" name="state" placeholder="provinsi" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Country :</span>
